defmodule Pbuf.Encoder do
  ...
  def field(:struct, %{__pbuf__: true} = val, prefix)  do
    [prefix, field(:struct, val)]
  end

  def field(:struct, %{__struct__: type} = val, <<prefix, _::binary>>) do
    raise Error,
      type: type,
      value: val,
      tag: bsr(prefix, 3),
      message: "#{inspect(type)} was not generated by Pbuf"
  end
  ...
  def oneof_field(choice, {choice, _value}, fun) do
    fun.()
  end
