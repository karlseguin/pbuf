defmodule Google.Protobuf.FileDescriptorSet do
  ...
  def encode_to_iodata!(data) do
    ...
    [
      Encoder.repeated_field(:struct, data.file, <<10>>),
    ]
  end
...
defmodule Google.Protobuf.FileDescriptorProto do
  ...
  def encode_to_iodata!(data) do
    ...
    [
      ...
      Encoder.repeated_field(:string, data.dependency, <<26>>),
      Encoder.repeated_field(:struct, data.message_type, <<34>>),
      Encoder.repeated_field(:struct, data.enum_type, <<42>>),
      Encoder.repeated_field(:struct, data.service, <<50>>),
      Encoder.repeated_field(:struct, data.extension, <<58>>),
      Encoder.field(:struct, data.options, <<66>>),
      Encoder.field(:struct, data.source_code_info, <<74>>),
      Encoder.repeated_field(:int32, data.public_dependency, <<82>>),
      Encoder.repeated_field(:int32, data.weak_dependency, <<90>>),
  ...
  def decode(acc, <<82, data::binary>>) do
    Decoder.repeated_field(:int32, :public_dependency, acc, data)
  end

  def decode(acc, <<90, data::binary>>) do
    Decoder.repeated_field(:int32, :weak_dependency, acc, data)
  end
...
defmodule Google.Protobuf.DescriptorProto do
  ...
  def encode_to_iodata!(data) do
    ...
    [
      Encoder.field(:string, data.name, <<10>>),
      Encoder.repeated_field(:struct, data.field, <<18>>),
      Encoder.repeated_field(:struct, data.nested_type, <<26>>),
      Encoder.repeated_field(:struct, data.enum_type, <<34>>),
      Encoder.repeated_field(:struct, data.extension_range, <<42>>),
      Encoder.repeated_field(:struct, data.extension, <<50>>),
      Encoder.field(:struct, data.options, <<58>>),
      Encoder.repeated_field(:struct, data.oneof_decl, <<66>>),
      Encoder.repeated_field(:struct, data.reserved_range, <<74>>),
      Encoder.repeated_field(:string, data.reserved_name, <<82>>),
    ]
  end
...
defmodule Label do
  @moduledoc false
  @type t :: :LABEL_OPTIONAL | :LABEL_REPEATED | :LABEL_REQUIRED | non_neg_integer
...
defmodule Type do
  @moduledoc false
  @type t :: :TYPE_BOOL | :TYPE_BYTES | :TYPE_DOUBLE | :TYPE_ENUM | :TYPE_FIXED32 | :TYPE_FIXED64 | :TYPE_FLOAT | :TYPE_GROUP | :TYPE_INT32 | :TYPE_INT64 | :TYPE_MESSAGE | :TYPE_SFIXED32 | :TYPE_SFIXED64 | :TYPE_SINT32 | :TYPE_SINT64 | :TYPE_STRING | :TYPE_UINT32 | :TYPE_UINT64 | non_neg_integer
  @spec to_int(t | non_neg_integer) :: integer
...
defmodule Google.Protobuf.EnumDescriptorProto do
  ...
  def encode_to_iodata!(data) do
    ...
    [
      Encoder.field(:string, data.name, <<10>>),
      Encoder.repeated_field(:struct, data.value, <<18>>),
      Encoder.field(:struct, data.options, <<26>>),
      Encoder.repeated_field(:struct, data.reserved_range, <<34>>),
      Encoder.repeated_field(:string, data.reserved_name, <<42>>),
    ]
  end
...
defmodule Google.Protobuf.EnumValueDescriptorProto do
  ...
  @type t :: %EnumValueDescriptorProto{
    name: String.t,
    number: integer,
...
defmodule Google.Protobuf.ServiceDescriptorProto do
  ...
  def encode_to_iodata!(data) do
    ...
    [
      Encoder.field(:string, data.name, <<10>>),
      Encoder.repeated_field(:struct, data.method, <<18>>),
      Encoder.field(:struct, data.options, <<26>>),
    ]
  end
...
defmodule OptimizeMode do
  @moduledoc false
  @type t :: :CODE_SIZE | :LITE_RUNTIME | :SPEED | non_neg_integer
  @spec to_int(t | non_neg_integer) :: integer
...
defmodule JSType do
  @moduledoc false
  @type t :: :JS_NORMAL | :JS_NUMBER | :JS_STRING | non_neg_integer
  @spec to_int(t | non_neg_integer) :: integer
...
defmodule CType do
  @moduledoc false
  @type t :: :CORD | :STRING | :STRING_PIECE | non_neg_integer
  @spec to_int(t | non_neg_integer) :: integer
...
defmodule Google.Protobuf.EnumValueOptions do
  ...
  @type t :: %EnumValueOptions{
    deprecated: boolean,
    uninterpreted_option: [Google.Protobuf.UninterpretedOption.t],
    erlang: Google.Protobuf.ErlangEnumValueOptions.t
  }
  ...
  def encode_to_iodata!(data) do
    ...
    [
      ...
      Encoder.repeated_field(:struct, data.uninterpreted_option, <<186, 62>>),
      Encoder.field(:struct, data.erlang, <<130, 191, 38>>),
    ]
  end
  ...
  # old version used 4369...keep this to suppor that
  def decode(acc, <<138, 145, 2, data::binary>>) do
    Decoder.struct_field(Google.Protobuf.ErlangEnumValueOptions, :erlang, acc, data)
  end
...
defmodule Google.Protobuf.ErlangEnumValueOptions do
  @moduledoc false
  alias Pbuf.{Decoder, Encoder}
  import Bitwise, only: [bsr: 2, band: 2]
...
defmodule IdempotencyLevel do
  @moduledoc false
  @type t :: :IDEMPOTENCY_UNKNOWN | :IDEMPOTENT | :NO_SIDE_EFFECTS | non_neg_integer
  @spec to_int(t | non_neg_integer) :: integer
...
defmodule Google.Protobuf.UninterpretedOption do
  ...
  def encode_to_iodata!(data) do
    alias Elixir.Pbuf.Encoder
    [
      Encoder.repeated_field(:struct, data.name, <<18>>),
...
defmodule Google.Protobuf.SourceCodeInfo do
  ...
  def encode_to_iodata!(data) do
    alias Elixir.Pbuf.Encoder
    [
      Encoder.repeated_field(:struct, data.location, <<10>>),
    ]
  end
...
defmodule Google.Protobuf.SourceCodeInfo.Location do
  ...
  def encode_to_iodata!(data) do
    ...
    [
      ...
      Encoder.repeated_field(:string, data.leading_detached_comments, <<50>>),
    ]
  end
...
defmodule Google.Protobuf.GeneratedCodeInfo do
  ...
  def encode_to_iodata!(data) do
    alias Elixir.Pbuf.Encoder
    [
      Encoder.repeated_field(:struct, data.annotation, <<10>>),
    ]
  end
